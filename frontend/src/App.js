...
export default function App() {
    ...
    return (
        <>
            <Routes>
                <Route path="/loginPaziente" element={<Authentication medico={false} login={true} handle={setLoggedUser}/>}/>
                <Route path="/signupPaziente" element={<Authentication medico={false} login={false} handle={setLoggedUser}/>}/>

                <Route path="/loginMedico" element={<Authentication medico={true} login={true} handle={setLoggedUser}/>}/>
                <Route path="/signupMedico" element={<Authentication medico={true} login={false} handle={setLoggedUser}/>}/>
